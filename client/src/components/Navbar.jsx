...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-sm shadow-sm shadow-slate-100">
      ...
      {user && mobileMenuOpen && (
        <div className="lg:hidden border-t border-slate-200 bg-white py-3 px-6 shadow-inner text-left max-h-[calc(100vh-4rem)] overflow-y-auto space-y-4">
          {/* User profile brief */}
          ...
          <div className="pt-3 border-t border-slate-100">
            <button
              ...
              className="flex w-full items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-bold text-rose-600 transition hover:bg-rose-50"
            >
              <LogOut className="h-4 w-4" />
              Sign Out
            </button>
