...
async function runTests() {
  ...
  try {
    ...
    console.log('- Listing ID (legacy):', savedCompat.listing)
    console.log('- TenantProfile ID (legacy):', savedCompat.tenantProfile)
    console.log('- Listing ID (new):', savedCompat.listingId)
    console.log('- Tenant ID (new):', savedCompat.tenantId)
    console.log('- Score:', savedCompat.score)
    console.log('- Explanation:', savedCompat.explanation)
    console.log('- Strengths:', savedCompat.strengths)
    console.log('- Weaknesses:', savedCompat.weaknesses)
    console.log('- Scoring Breakdown:', savedCompat.scoringBreakdown)
    console.log('- Scoring Method:', savedCompat.scoringMethod)
    console.log('- LLM Provider:', savedCompat.llmProvider)
